...
2. [Features](https://github.com/krisztinatxt/lockdown-kitchen-ms3#features)
...
3. [Testing](https://github.com/krisztinatxt/lockdown-kitchen-ms3#testing)
4. [Deployment](https://github.com/krisztinatxt/lockdown-kitchen-ms3#deployment)
...
5. [Technologies Used](https://github.com/krisztinatxt/lockdown-kitchen-ms3#technologies-used)
6. [Credits](https://github.com/krisztinatxt/lockdown-kitchen-ms3#credits)
...
This cookbook is for people who are working from home or spending most of their time at home during the quarantine ordained because of the pandemic, but they want to cook or bake something easy and tasty from a couple of ingredients. All of the dishes are made from a couple of ingredients anybody can find in their kitchen.
...
- [x] delete recipes.
- [x] see the details about a pratical recipe.
- [x] send a feedback to the developer, so they can fix the bugs sooner.
- [x] get success or error message to know my feedback was successfully submitted.

### Developer Goals

- Provide a nice, easy to use online cookbook where the user can create, edit, delete recipes, and filter them by categories and ingredients.
...
- if there are no results found for the keyword, the user can quickly add a new recipe, or browse for other recipes.

#### Get all recipes

- the user can reach the list of all the available recipes on one page, so if they are clueless, they can simply browse.
...
- When the user will be able create a profile, I would like to build some other features like _Add to your favorites_ or _Share this recipe_.
...
At the bottom of the box you can find a link to access the list of the recipes. The link is tested, works without problem.
...
The image, the title and the view recipe anchor tag are all clickable. When the user clicks at any of them, the full page of the respective recipe loads.
When the user clicks on the name of the category, they get a list of the recipes in the same category.
Links are tested, everything worked.

### Recipe Page

As I mentioned above, when the user clicks on certain components of the card, will be redirected to the full version of the recipe.
The page contains:
...
1. When the user clicks on the edit, they can see the recipe's form in an editable version.
When the modification is submitted, the recipe will be updated, and the user will be redirected to the All recipes page.

2. When the user clicks on the Delete button, the selected recipe will be removed from the database, the page of All recipes loads automatically.
...
- All fields start with a Materialize Icon to illustrate the point of the information.
